...
/* compress 512-bits */
static int sha256_compress(struct rtww_sha256_state *md, unsigned char *buf)
{
	u32 S[8], W[64], t0, t1;
	u32 t;
	int i;
...
static void rtw_sha256_init(struct rtww_sha256_state *md)
{
	md->curlen = 0;
	md->length = 0;
...
*/
static int sha256_process(struct rtww_sha256_state *md, unsigned char *in,
			  unsigned long inlen)
{
	unsigned long n;
...
/**
   ...
   @return CRYPT_OK if successful
*/
static int sha256_done(struct rtww_sha256_state *md, unsigned char *out)
{
	int i;
